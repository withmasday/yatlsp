        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card border-0 rounded-3 shadow-lg px-5">
                    <h4 class="text-primary text-center mt-5">{{ config('app.name', 'Laravel') }} | Sign Up</h4>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mt-3">
                                <label for="password" class="text-secondary">{{ __('Confirm Password') }}</label>
                                <div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <a href="{{ route('login') }}" class="btn btn-primaryc w-100 py-2 mt-3 mb-5">
                                        {{ __('Already Sign Up? Here') }}
                                    </a>
                                </div>
                            </div>
                        </form>
